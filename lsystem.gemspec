# -*- encoding: utf-8 -*-
# stub: lsystem 0.2.0.pre.20200226133830 ruby lib

Gem::Specification.new do |s|
  s.name = "lsystem".freeze
  s.version = "0.2.0.pre.20200226133830"
  ...
  s.files = ["".freeze, ".simplecov".freeze, "History.md".freeze, "README.md".freeze, "Rakefile".freeze, "examples/fern_gn7.png".freeze, "lib/lsystem.rb".freeze, "lib/lsystem/production_adapter.rb".freeze, "lib/lsystem/rules_engine.rb".freeze, "spec/lsystem/production_adapter_spec.rb".freeze, "spec/lsystem/rules_engine_spec.rb".freeze, "spec/lsystem_spec.rb".freeze, "spec/spec_helper.rb".freeze]
