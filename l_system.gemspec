# -*- encoding: utf-8 -*-
# stub: l_system 0.2.0.pre.20200226150224 ruby lib

Gem::Specification.new do |s|
  s.name = "l_system".freeze
  s.version = "0.2.0.pre.20200226150224"
  ...
  s.files = [".simplecov".freeze, "History.md".freeze, "README.md".freeze, "Rakefile".freeze, "examples/fern_gn7.png".freeze, "lib/l_system.rb".freeze, "lib/l_system/production_adapter.rb".freeze, "lib/l_system/rules_engine.rb".freeze, "spec/l_system/production_adapter_spec.rb".freeze, "spec/l_system/rules_engine_spec.rb".freeze, "spec/l_system_spec.rb".freeze, "spec/spec_helper.rb".freeze]
